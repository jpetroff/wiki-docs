export interface FileEntry { kind: 'file'; name: string; path: string; title?: string }
...
export const entryTitle = (entry: NavigationEntry, rootTitle = 'Documentation') => entry.title || entry.name || rootTitle;
